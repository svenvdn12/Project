...
<section class="over-ons">
    ...
    <details>
        ...
        <section class="details-content">
            ...
            <p>
                Bij de ontmoetingsgroep komen we 10 keer samen, 1 keer per week, en bespreken we thema’s
                rondom persoonlijke ontwikkeling en neurodivergentie.
...
<section class="mogelijk-gemaakt-door">
    ...
    <section class="item-grid">
        ...
        <article class="item">
            <p>REA College Heerhugowaard - Website development</p>
        </article>
        <article class="item">
            <p>REA College Leiden - Website development</p>
        </article>
    </section>
</section>
</div>